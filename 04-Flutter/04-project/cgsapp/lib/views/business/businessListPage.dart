...
import 'package:cgsapp/models/businessListModel.dart';
import 'package:cgsapp/utils/http/http.dart';
import 'package:flutter/material.dart';

class BusinessListPage extends StatefulWidget {
  BusinessListPage({Key key}) : super(key: key);
...
class _BusinessListPageState extends State<BusinessListPage>
  ...
  void initState() {
    super.initState();
    Http.httpRequest(ApiName.businessListApiName, {}).then((HttpResult result) {
      if (result.success) {
