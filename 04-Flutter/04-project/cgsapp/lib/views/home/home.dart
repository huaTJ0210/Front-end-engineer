...
import 'package:cgsapp/models/bannerModel.dart';
import 'package:cgsapp/models/businessModel.dart';
import 'package:cgsapp/views/home/businessWidget.dart';
...
class _HomePageState extends State<HomePage> {
  @override
  void initState() {
    Http.httpRequest(ApiName.bannerApiName, {}).then((HttpResult result) {
      if (result.success) {
        setState(() {
